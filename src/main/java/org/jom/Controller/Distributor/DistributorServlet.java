            ...
            if (user.getId() != 0) {
                if (user.getRole().equals("distributor")) {
                    ...
                    if (products.size() != 0) {
                        ...
                        out.write("{\"list\":" + objectArray + ",\"accepted\":" + productsDAO.acceptedProductCount() + ",\"allocated\":" + distributionDAO.allocatedAcceptedProductCount(user_id) + ",\"distributions\":" + distributionsArray + ",\"visits\":"+visits+",\"outlets\":" + outletDAO.rowCount()+"}");
                        System.out.println("View all remaining Products");
                    } else {
                        response.setStatus(HttpServletResponse.SC_ACCEPTED);
                        out.write("{\"size\": 0,\"accepted\":" + productsDAO.acceptedProductCount() + ",\"allocated\":" + distributionDAO.allocatedAcceptedProductCount(user_id) + ",\"distributions\":" + distributionsArray + ",\"visits\":"+visits+",\"outlets\":" + outletDAO.rowCount()+"}");
